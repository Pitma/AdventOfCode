...
class AoCSolver:
    def __init__(self, level: int = 1):
        self.level = level
        self.sample_answers = {
            1: 21,  # Replace with actual sample answer for part 1
            2: 40   # Replace with actual sample answer for part 2
        }
    ...
    def solve_part2(self, data: Any) -> Union[int, str]:
        ...
        def find_next(r,c):
            ...
            node = data[r][c]
            if node == "." or node == "S":
                return find_next(r+1,c)
            elif node =="^":
                return find_next(r,c-1) + find_next(r,c+1)
